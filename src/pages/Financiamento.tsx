...
import { Plus, CreditCard, Calendar, DollarSign, Building, User, Eye, Edit, TrendingUp } from "lucide-react";
import { Label } from "@/components/ui/label";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import FinanciamentoForm from "@/components/forms/FinanciamentoForm";
import FinancingComparison from "@/components/financing/FinancingComparison";
      ...
      <Tabs defaultValue="mercado" className="w-full">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">Análise de mercado • Comparação de bancos • Gestão de solicitações</p>
          </div>
          <TabsList>
            ...
            <TabsTrigger value="gestao" className="flex items-center space-x-2">
              <CreditCard className="h-4 w-4" />
              <span>Meus Financiamentos</span>
            </TabsTrigger>
          </TabsList>
        </div>
